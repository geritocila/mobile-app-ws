...
public class AmazonSES {
    ...
    final String FROM = "geritocila@gmail.com";
    ...
    final String PASSWORD_RESET_TEXTBODY = "A request to reset your password "
            ...
            + " http://ec2-18-184-17-85.eu-central-1.compute.amazonaws.com:8080/verification-service/password-reset.html?token=$tokenValue"
            + " Thank you!";
    ...
    public void verifyEmail(UserDto userDto) {
        ...
        System.setProperty("aws.accessKeyId", "AKIAIZJAXHJCJOAVDS2A");
        System.setProperty("aws.secretKey", "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");
